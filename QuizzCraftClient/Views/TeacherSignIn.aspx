<%@ Page Title="" Language="C#" MasterPageFile="~/Views/QuizzCraft.Master" AutoEventWireup="true" CodeBehind="TeacherSignIn.aspx.cs" Inherits="QuizzCraftClient.Views.TeacherSignIn" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img width="130px" src="/images/teacher.png" />
                                </center>
                            </div>
                        </div>

                        <h3 class="text-center">Teacher SignIn</h3>
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="TeacherSignUp.aspx" class="btn btn-info btn-block">Sign Up</a>
                        </div>
