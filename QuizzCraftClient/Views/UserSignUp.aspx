<%@ Page Title="" Language="C#" MasterPageFile="~/Views/QuizzCraft.Master" AutoEventWireup="true" CodeBehind="UserSignUp.aspx.cs" Inherits="QuizzCraftClient.Views.UserSignUp" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            &nbsp;
                            </label><asp:RequiredFieldValidator ID="rfvEmail" runat="server" ControlToValidate="tbEmail" ErrorMessage="Email is required" ForeColor="Red"></asp:RequiredFieldValidator>
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="UserSignIn.aspx" class="btn btn-info btn-block">SignIn</a>
                        </div>
